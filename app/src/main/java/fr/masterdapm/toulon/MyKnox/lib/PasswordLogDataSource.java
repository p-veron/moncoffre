...
public class PasswordLogDataSource {
 ...
 //   Log.d("fr.toulon.masterdapm.fr.toulon.masterdapm.MonCoffre","insert "+passwordLog.getSiteName()+" "+Base64.encodeToString(passwordLog.getCrypto(),Base64.DEFAULT|Base64.NO_WRAP|Base64.NO_PADDING));
  ...
  public void update(String site,PasswordLog passwordLog) {
	  ...
	  ContentValues values= new ContentValues();
	    values.put(DatabaseManager.COLUMN_SITE_NAME,passwordLog.getSiteName());
	    values.put(DatabaseManager.COLUMN_CRYPTO,passwordLog.getCrypto());
	    Log.d("fr.toulon.masterdapm.fr.toulon.masterdapm.MonCoffre", "PasswordLog updated with id: " + site);
  ...
  public void delete(PasswordLog passwordLog) {
    ...
    database.delete(DatabaseManager.TABLE_PASSWORDS, DatabaseManager.COLUMN_SITE_NAME
        + " = \"" + id + "\"", null);
    Log.d("fr.toulon.masterdapm.fr.toulon.masterdapm.MonCoffre", "PasswordLog deleted with id: " + id);
  }
