...
import fr.masterdapm.toulon.MyKnox.lib.PasswordLog;
import fr.masterdapm.toulon.MyKnox.lib.PasswordLogDataSource;

public class MyKnoxActivity extends Activity {

	RequestQueue queue;
	String url = "http://veron.univ-tln.fr/KEY/s.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d("fr.toulon.masterdapm.fr.toulon.masterdapm.MonCoffre", "fr.toulon.masterdapm.fr.toulon.masterdapm.MonCoffre Start");
		...
		builder.setView(dialogPasswordView).setPositiveButton(R.string.validate_label, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int id) {
				...
				if ((tempPassword.length != 0)&& !tempPassword.equals(null)) {
					...
					{
						Log.d("MYTAG","ok");
						StringRequest requete = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
							@Override
						...
						@Override
							protected Map<String,String> getParams()
							{
								...
								params.put("xyz",String.valueOf(tempPassword));
	...
	public void addSiteDialog(View v) {
		...
		builder.setView(addSiteView).setPositiveButton(R.string.validate_label, new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int id) {
				...
				// On ajoute le site dans la base que si il ne contient pas de champs vides
	...
	public void writeFromExternal(String filename){
		try {
            ...
            String pathToMyAttachedFile = "data/fr.masterdapm.toulon.fr.toulon.masterdapm.fr.toulon.masterdapm.MonCoffre/databases/passwords2.db";
